...
export default function LoginPage() {
  ...
  function handleForgotPassword(e: React.MouseEvent<HTMLButtonElement>) {
    ...
    setResetInfo("redefinicao de senha enviada pelo seu email xxx@xx");
  }
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-accent/5 to-background">
        ...
        <div className="absolute top-8 left-8 z-10">
          <Link href="/" className="flex items-center gap-1">
            <span
              className="text-accent font-bold text-3xl italic notranslate"
              translate="no"
            >
              Elite
            </span>
            <span
              className="text-2xl font-bold text-foreground notranslate"
              translate="no"
            >
              trader
            </span>
        ...
        <div className="absolute inset-0">
          ...
          >
            <path
              d="M-50 300 Q 100 200 250 280 T 500 250 T 750 300 T 900 280"
              stroke="url(#loginGrad1)"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M-50 400 Q 100 300 250 380 T 500 350 T 750 400 T 900 380"
              stroke="url(#loginGrad2)"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M-50 500 Q 100 400 250 480 T 500 450 T 750 500 T 900 480"
              stroke="url(#loginGrad3)"
              strokeWidth="2"
              fill="none"
            />
            <defs>
        ...
        <div className="absolute bottom-32 left-16 w-20 h-20 opacity-60">
          <div
            className="w-full h-full bg-gradient-to-br from-blue-400 to-cyan-500 rounded-xl transform rotate-12 shadow-lg"
            style={{
              clipPath:
        ...
        <div className="absolute top-1/2 right-16 w-24 h-24 opacity-60">
          <div
            className="w-full h-full bg-gradient-to-br from-gray-600 to-gray-800 rounded-full transform shadow-lg"
            style={{
              background:
                "conic-gradient(from 0deg, #374151, #6b7280, #9ca3af, #6b7280, #374151)",
            }}
          />
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 py-8 sm:py-10">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            {error && (
              <p className="text-sm text-red-500 text-center bg-red-500/10 border border-red-500/20 rounded-lg px-3 py-2">
                {error}
              </p>
            )}
